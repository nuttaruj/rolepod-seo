...
| — | **DECLINED** docx / PDF export (owner, 2026-09-03) | No `python-docx`, no LibreOffice, no browser automation for export, PDF not documented as a deliverable; a small `@media print` block stays in the HTML as a zero-cost nicety | Owner: "ทำเป็น HTML หรือ artifact ก็ได้ ไม่ต้องทำเป็น docx+PDF" |
